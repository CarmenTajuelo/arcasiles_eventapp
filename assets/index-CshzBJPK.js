...
.card-description {
  ...
  margin: 0;
        ...
        `}};window.customElements.define(`event-card`,pe);var me=class extends ${render(){return V`
    ...
    `}static get styles(){return o`
       ...
       .event-list {
        ...
        `}};window.customElements.define(`event-list`,me);var he=class extends ${render(){return V`
            <nav class="nav-bar">
        ...
        a:hover {
            color: var(--yellow);
                ...
                `}};window.customElements.define(`nav-bar`,he);var ge=class extends ${render(){return V`
            <footer class="footer">
                <img src="./src/assets/logo-arcasiles.png" alt="logo arcasiles" class="logo">
                <div class="socials">
        ...
        `}static get styles(){return o`
            ...
            p {
                ...
                `}};window.customElements.define(`arc-footer`,ge);